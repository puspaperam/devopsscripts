pipeline {
    ...
    stages {
        ...
        stage('Deploy to Tomcat') {
            steps {
                deploy adapters: [tomcat7(alternativeDeploymentContext: '', credentialsId: 'tomcat_cre', path: '', url: 'http://192.168.124.129:8080/')], contextPath: 'myapp', war: '**/*.war'deploy adapters: [tomcat7(alternativeDeploymentContext: '', credentialsId: 'tomcat_cre', path: '', url: 'http://192.168.124.129:8080/')], contextPath: 'myapp', war: '**/*.war'
